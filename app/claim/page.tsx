  ...
  return shell(
    <>
      ...
      <p style={{ fontSize: "1.1rem", color: "var(--muted)", lineHeight: 1.6, marginBottom: "1.6rem" }}>
        Welcome! Check the details below, fix anything that is wrong, and this listing is yours. Players will be sent to your own website and pages; money never crosses our table.
      </p>
