...
export const metadata: Metadata = {
  ...
  description:
    "Ask where to play American mahjong in plain English. Answers come only from verified listings: real games, real teachers, real schedules.",
  ...
  return (
    <main style={{ maxWidth: 1000, margin: "0 auto", padding: "2.5rem 1.2rem 4rem" }}>
      ...
      <p style={{ fontSize: "1.15rem", color: "var(--muted)", textAlign: "center", lineHeight: 1.5, margin: "0 0 1.8rem" }}>
        Ask in plain English. Every answer comes from verified listings, never a guess.
      </p>
      <AskClient />
      <p style={{ fontSize: "0.85rem", color: "var(--muted)", textAlign: "center", marginTop: "2.5rem", maxWidth: 560, marginLeft: "auto", marginRight: "auto" }}>
        Ask searches the same verified directory as the Events and Teachers pages. If nothing is
