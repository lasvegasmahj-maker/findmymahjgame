...
export const metadata: Metadata = {
  ...
  description:
    "Find a local mahjong game in 3 steps, or list your venue, event or business for free. See how Find My Mahj Game connects players and advertisers nationwide.",
  alternates: {
