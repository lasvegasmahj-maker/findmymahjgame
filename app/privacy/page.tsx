        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "2rem", color: "var(--muted)", lineHeight: 1.75, fontSize: "0.93rem" }}>
          ...
          <section>
            ...
            <ul style={{ paddingLeft: "1.5rem", marginTop: "0.5rem" }}>
              ...
              <li>Deliver lesson requests. When you send a lesson request, we email your name, contact details, and message directly to that teacher so they can reply. We keep no copy of your message or contact details, only a delivery record (which teacher, when, and whether the email sent) to spot abuse and confirm delivery</li>
