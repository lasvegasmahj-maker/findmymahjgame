...
export const HELD_OUT = [
  ...
  A("if she says wait and I say call who gets the discard", "two-players-same-tile", "hold-or-wait"),
  ...
  A("what's the penalty for a bad mahjong call", "mahjong-in-error", "mahjong-in-error-settlement"),
  ...
  A("only three of us showed up, can we still play", "players-count", "three-player-procedure"),
  ...
  A("she gave me the wrong tile for my joker", "joker-exchange-wrong-tile"),
  A("someone put the wrong tile in when they took my joker", "joker-exchange-wrong-tile"),
  ...
  A("she called it a 3 dot but threw a 3 crak and I called mahjong on it", "misnamed-discard"),
  A("dead hand, can the rest of us take her jokers", "dead-hand-jokers"),
  A("claiming a discard for a quint", "calling-quints-sextets"),
  A("who pays when the mahjong call turns out wrong", "mahjong-in-error-settlement"),
  A("three of us tonight, do we still pass", "three-player-procedure"),
  A("I ended up with 14 tiles before east threw, redeal?", "wrong-tile-count-before-play"),
  A("if I shout hold do I get the tile", "hold-or-wait"),
  A("I drew before she discarded, am I dead", "picking-ahead"),
  A("does the discarder pay more", "payments-basics"),
  A("what happens to my hand if I call maj wrong and lay it down", "mahjong-in-error"),
];
