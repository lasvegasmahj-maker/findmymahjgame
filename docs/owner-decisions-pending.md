...
11. Rules truth layer (2026-08-30): fourteen rules questions and wording flags for Shauna are listed in docs/rules-truth-audit-2026-08-30.md (misnamed discards, jokers in a dead hand, confirming the quint and sextet call, the last discard of the deal, settlement after a false mahjong, the official three-player procedure, annual-card wording, false mahjong with tiles exposed, picking ahead, payment wording, a wrong tile count before East's first discard, the wrong-joker-exchange penalty, hold or wait as a call, the consequence after a wrong joker exchange). 29 new or research-verified Ask entries await owner review; nothing owner-approved was changed.
