...
11. Rules truth layer (2026-08-30): RESOLVED. Shauna decided all thirteen final rule questions on 2026-08-30 (ten approved as recommended, #4 and #9 approved with her specified changes, #6 approved end-counts-only, #12 approved after she supplied the resolving source). No Ask entry defers to the instructor any more. Two narrow points have no published League ruling and are published as unsettled: the exposure call on the deal's final discard, and whether an out-of-turn discard may be claimed for an exposure. A clarification letter for both is drafted in docs/league-clarification-request.md. Record: docs/rules-truth-audit-2026-08-30.md.
