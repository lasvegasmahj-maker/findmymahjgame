...
//   verified    = ownership verified through the evidence-based claim process (trust, never bought)
//   premium     = paid or trial commercial membership (a business status, not a trust designation)
...
const BADGES = {
  ...
  premium: { symbol: "✦", label: "Premium Provider", bg: "rgba(233,30,140,0.06)", color: "var(--pink-text)", border: "rgba(233,30,140,0.30)" },
